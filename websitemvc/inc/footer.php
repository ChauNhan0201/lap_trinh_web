			...
			<div class="row">
				<div class="col-sm-3 cotf1 mb-2 wow fadeInUp" data-wow-delay="0s">
					...
					<div class="motdong">
						...
						<span class="textmd">Address : Số 79, đường Nguyễn Thị Minh Khai, TPHCM</span>
					</div>
					<div class="motdong">
						<i class="fa fa-phone"></i>
						<span class="textmd">Phone : (+84) 123 456 789</span>
					</div>
					<div class="motdong">
						<i class="fa fa-envelope-o"></i>
						<span class="textmd">Email : support@coffee.com</span>
					</div>
